...
namespace GS_Shop.Data.Repositories
{
    ...
    public class ErrorRepository : RepositoryBase<Error>, IErrorRepository //RepositoryBase cần truyền vào 1 kiểu theo tác
    {
        public ErrorRepository(IDbFactory dbFactory) : base(dbFactory) //nhận đối tượng truyền vào là 1 đối tượng DbFactory
        {
