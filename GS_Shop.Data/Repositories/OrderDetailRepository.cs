...
{
    public interface IOrderDetailRepository : IRepository<OrderDetail>  //interface này dùng để định nghĩa các phương thức cần phải thêm k nằm trong RepositoryBase
    {
    }
    ...
    {
        public OrderDetailRepository(IDbFactory dbFactory) : base(dbFactory) //nhận đối tượng truyền vào là 1 đối tượng DbFactory
        {
